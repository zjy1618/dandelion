...
<div id="page-content-wrapper">
    ...
    <div id="page-content">
        <form id="form" action="/product/add"  method="POST" enctype="multipart/form-data" class="col-md-10 left-margin">
            <div >
                <div class="form-row">
                ...
                <div class="form-row">
                    ...
                    <div class="form-input col-md-5">
                        <select id="productSort" name="productSort.id">
                            <#list productSort_list as productSort><option value="${productSort.id}">${productSort.name}</option></#list>
                        </select>
                    </div>
                </div>
                <div class="form-row">
